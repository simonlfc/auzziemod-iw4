...
init()
{
    ...
    {
        redux\common::console_print( "Voting", "map_voting.cfg not found, aborting vote..." );
        return;
    }
    ...
    {
        redux\common::console_print( "Voting", "Not enough maps specified in map_voting.cfg, aborting vote..." );
