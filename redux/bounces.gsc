// shameless copy paste from who knows where
...
init()
{
	...
	add_bounce( ( -1343.02, 1008.54, -4.00832 ), "mp_nuked" );
	add_bounce( ( -202.84, 145.365, 36.5384 ), "mp_nuked" );
...
add_bounce( coords, mapname, bounceRadius, bounceMultiplier )
{
